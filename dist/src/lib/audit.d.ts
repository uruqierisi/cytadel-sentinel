 ...
 */
export type AuditAction = "RUN_START" | "RUN_COMPLETE" | "RUN_FAILED" | "SCOPE_LOAD" | "SCOPE_ACCEPT" | "SCOPE_REJECT" | "STAGE_START" | "STAGE_COMPLETE" | "TOOL_EXEC" | "TARGET_TOUCHED" | "IMPORT" | "REPORT" | "DESTRUCTIVE_GATE";
